# test-cloud-run-auth.ps1
# PowerShell script to test the frontend with Cloud Run IAM authentication
...
try {
    ...
    Write-Host "   Make sure you're authenticated with: gcloud auth login" -ForegroundColor Yellow
...
Write-Host
Write-Host "Note: The identity token expires in ~1 hour" -ForegroundColor Yellow
